...
public class Entreprise {
    ...
    public void testConn() throws Exception {
        ...
        driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Ajouter un animal'])[1]/following::label[1]")).click();
        driver.findElement(By.id("vsb-train-launch-code-fce")).clear();
        driver.findElement(By.id("vsb-train-launch-code-fce")).sendKeys("C01E880");
