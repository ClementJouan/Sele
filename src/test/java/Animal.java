...
public class Animal {
    ...
    public void testConn() throws Exception {
        ...
        driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Ajouter un vélo'])[1]/following::span[2]")).click();
        driver.findElement(By.id("vsb-train-launch-animals-box")).click();
        new Select(driver.findElement(By.id("vsb-train-launch-animals-box"))).selectByVisibleText("1");
        driver.findElement(By.id("vsb-train-launch-animals-box")).click();
        driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Voir le Calendrier des prix'])[1]/following::span[2]")).click();
