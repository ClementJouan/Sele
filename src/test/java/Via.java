...
public class Via {
    ...
    public void testConn() throws Exception {
        ...
        driver.findElement(By.id("vsb-train-launch-via-toggle")).click();
        driver.findElement(By.id("vsb-train-launch-via")).click();
        driver.findElement(By.id("vsb-train-launch-via")).clear();
        driver.findElement(By.id("vsb-train-launch-via")).sendKeys("Angers (toutes gares)");
        driver.findElement(By.id("vsb-via-0")).click();
